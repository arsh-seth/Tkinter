...
root = Tk()
root.title("CodeWithArsh News - Aapka Apna Akhabaar")
...
Label(f0, text="Code With Arsh News", font="lucida 33 bold").pack()
Label(f0, text="May 5, 2020", font="lucida 13 bold").pack()
f0.pack()
