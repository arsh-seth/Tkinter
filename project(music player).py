...
if __name__ == '__main__':
    ...
    # Add & Delete Button
    frame = Frame(root)
    Button(frame, text="Add",bg="skyblue", pady=8, padx=20, font="lucida 10", command=add_music).pack(side=LEFT, padx=20)
    Button(frame, text="Delete",bg="skyblue", pady=8, padx=16, font="lucida 10", command=delete_music).pack(side=LEFT)
    frame.pack(padx=20)

    # Play Button
    Button(root, text="Play", font="lucida 10 bold", pady=8, padx=16, bg="purple", fg="white", command=play_music).pack(pady=10)

    Label(root, text="Created By ARSH SETH", font="lucida 10", bg="skyblue", fg="black").pack(fill=X, pady=25)
    Label(root, text="Hey, We are SUCCESSFULL in creating this GUI", font="lucida 10", bg="black", fg="white").pack()
